...
public class Game {
    ...
    public Game(Context context) {
        ...
        // Определяем количество уровней кампании
        ...
        // Создаем пустые массивы под игровые уровни на уровнях кампании
        for (int i = 0; i < countRanges; i++)
        	levels.add(new ArrayList<String>());
        // Заполняем массивы игровых уровней на уровнях кампании
    ...
    // Устанавливаем текущий уровень кампании
    ...
    // Устанавливаем текущий индекс игрового уровня на текущем уровне кампании
    ...
    // Возвращаем текущий уровень кампании
    public int getCurrentRange() {
    	return currentRange;
    }

    // Возвращаем текущий индекс игрового уровня на текущем уровене кампании
